...
namespace WebsiteDatXeCongNghe.Controllers
{
    public class DatXeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult GoogleMapThongTinDatXe(string distance, string duration, string totalFare, string location1, string location2, string type, string phone, string payment, string DateTime, bool Status, string PassengerImage, string PassengerName, string PassengerEmail)
        {
            ...
            {
                System.DateTime dt;
                if (System.DateTime.TryParse(DateTime, out dt))
                    dx.NgayGioDat = dt;
                else
                    dx.NgayGioDat = System.DateTime.Now;
            }
            else
            {
                dx.NgayGioDat = System.DateTime.Now;
